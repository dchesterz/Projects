...
Select *
From [ProjectPortifolio2].[dbo].Sheet1$
...
From [ProjectPortifolio2].[dbo].NashvilleHousing
...
From 
  [ProjectPortifolio2].[dbo].NashvilleHousing a 
  JOIN [ProjectPortifolio2].[dbo].NashvilleHousing b on a.ParcelID = b.ParcelID 
...
Select 
  PropertyAddress 
From 
  [ProjectPortifolio2].[dbo].NashvilleHousing 
  --Where PropertyAddress is null
  --order by ParcelID
